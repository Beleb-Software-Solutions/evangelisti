...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: oLYVPsXQxEKj/css
...
function PlasmicFaq__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div className={classNames(projectcss.all, sty.freeBox__uirVr)}>
          {renderPlasmicSlot({
            defaultContents: (
              <div
                className={classNames(
        ...
        >
          <FrameIcon
            className={classNames(projectcss.all, sty.svg___5Nzrg, {
              [sty.svgopen___5Nzrg57Jjc]: hasVariant($state, "open", "open")
            })}
            role={"img"}
          />

          <FrameIcon
            className={classNames(projectcss.all, sty.svg__phPlk, {
              [sty.svgopen__phPlk57Jjc]: hasVariant($state, "open", "open")
            })}
            role={"img"}
          />
        </div>
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__gTdYp, {
          [sty.freeBoxopen__gTdYp57Jjc]: hasVariant($state, "open", "open")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
